...
dotnet f 4.2.7 (https://dotnet.microsoft.com/download/dotnet-framework/net472 - minimum version : 4.2.7),
Node.JS (https://nodejs.org/en/download/current/ - minimum version : 16.7.0).

If you do the installations. If you are living, you can create a request from the project/Issues tab. 
```

```
Config (JSON) Detailing and WebAPI Configuration

Warning! : This article contains technical details. If you do not have much knowledge, it is 
recommended not to play with the settings.
